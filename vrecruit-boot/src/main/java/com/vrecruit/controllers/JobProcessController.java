...
//	JobProcessDetails jobProcessDetails;
	/*@GetMapping("job/{id}")
	public Optional<JobProcessDetails> getByUserId(@PathVariable Long id){
	...
	*/
	...
	/*
	@GetMapping("jobprocess/{id}")
	public Optional<JobProcessDetails> get(@PathVariable Long id){
		Optional<JobProcessDetails> job=	jobprocessrepo.findByJobid(id);
		return job;
